...
class Elevator { //Initial Class that contains the information of the elevator, as well as the methods for emergency break and reset.
    constructor(CurrentFloor, doorsOpen, toThePenthouse, toTheLooby){
...
ElevatorA = new Elevator(9, true, false); //Initializes elevator A to floor #9
ElevatorB = new Elevator(1, false, true); //Initializes elevator B to floor #1
var totalTime = 0;

for (var i = 1; i < 101; i++){
    var randomFloorTo = Math.floor(Math.random() * 11);   
    var randomFloorFrom = Math.floor(Math.random() * 11);   
    console.log("Person: " + i.toString() + " going from: " + randomFloorFrom.toString() + " to: " + randomFloorTo.toString());
    if (randomFloorTo == randomFloorFrom){ //Case if the person is already on the same floor
        console.log("No need for elevator, person is already on the same floor!");
    }else if ((randomFloorFrom === 0 && randomFloorTo === 10) || (randomFloorFrom === 10 && randomFloorTo === 0)){
        console.log("Person can't go to that floor!");
    }else if (randomFloorTo == 10){ //Case if the person wants to go to the Penthouse
        console.log("Elevator A is on the floor: " + ElevatorA.CurrentFloor.toString() + ", estimated time to arrival: " + Math.abs(ElevatorA.CurrentFloor-randomFloorFrom) + " seconds");
        console.log("Closing doors... Elevator A is moving to floor: " + randomFloorFrom.toString());
        console.log("Elevator A has reached floor " + randomFloorFrom.toString() + ", Opening Doors....");
        console.log("Closing doors... Elevator A is moving to floor: " +  randomFloorTo.toString());
        console.log("Elevator A has reached floor " + randomFloorTo.toString() + ", Opening Doors....");
        ...
        console.log("Elevator B is on the floor: " + ElevatorB.CurrentFloor.toString()+ ", estimated time to arrival: " + Math.abs(ElevatorB.CurrentFloor-randomFloorFrom) + " seconds");
        console.log("Closing doors... Elevator B is moving to floor: " + randomFloorFrom.toString());
        console.log("Elevator B has reached floor " + randomFloorFrom.toString() + ", Opening Doors....");
        console.log("Closing doors... Elevator B is moving to floor: " +  randomFloorTo.toString());
        console.log("Elevator B has reached floor " + randomFloorTo.toString() + ", Opening Doors....");
...
console.log("The total time it took to move the 100 persons was: " + totalTime.toString() + " seconds");